...
//    #define tris_usb_bus_sense  U1OTGSTATbits.SESVD // Input
...
//    #define PIC24FJ256GB110_PIM
    ...
    /** LED ************************************************************/
    #define mInitAllLEDs()      PORTB |= 0x3000; TRISB &= ~(0x3000);
    
    #define mLED_1              PORTBbits.RB12
    #define mLED_2              PORTBbits.RB13
    ...
    /** SWITCH *********************************************************/
    #define mInitSwitch1()      TRISBbits.TRISB14 = 1; CNPU3bits.CN32PUE = 1;
